...
storiesOf('ListButton', module).add('All ButtonIDs', () => (React.createElement(WrapperList, null,
    ...
    React.createElement(ListButton, { id: 'to_dashboard', onClick: action('onClick to_dashboard') }),
    React.createElement(ListButton, { id: 'logout', onClick: action('onClick logout') }))));
